...
{
    /// <inheritdoc />
    public partial class InitStoreFixed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketAlerts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MarketAlertProducts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MarketAlertId = table.Column<int>(type: "integer", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketAlertProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarketAlertProducts_MarketAlerts_MarketAlertId",
                        column: x => x.MarketAlertId,
                        principalTable: "MarketAlerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MarketAlertProducts_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketAlertProducts_MarketAlertId",
                table: "MarketAlertProducts",
                column: "MarketAlertId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketAlertProducts_ProductId",
                table: "MarketAlertProducts",
                column: "ProductId");
